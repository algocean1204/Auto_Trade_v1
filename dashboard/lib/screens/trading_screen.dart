...
class _TradingScreenState extends State<TradingScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              if (activeCount == 0)
                ...
                // 포지션 행 렌더링
                ..._sortedPositions(provider.positions).map(
                  (pos) => _buildPositionRow(pos),
                ),
  ...
  List<Map<String, dynamic>> _sortedPositions(List<dynamic> positions) {
    final list = positions.cast<Map<String, dynamic>>().toList();
    list.sort((a, b) {
      int cmp;
      switch (_sortBy) {
        case 'ticker':
          cmp = (a['ticker'] as String? ?? '')
              .compareTo(b['ticker'] as String? ?? '');
        case 'value':
        ...
        children: [
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                Text('$qty', style: AppTypography.numberSmall),
                Text(
